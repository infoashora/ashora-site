    ...
    <section className="relative h-[70vh] min-h-[520px] w-full overflow-hidden">
      ...
      {slides.map((s, i) => (
        ...
        >
          ...
          {/* darker overlay (what you liked before) */}
      ...
      <div className="relative z-10 h-full grid place-items-center px-6 text-center">
        <div className="max-w-3xl space-y-5">
          ...
          <p className="text-base md:text-lg text-white/95 italic">
            Ashora isnâ€™t just a brand or productâ€”it's a service to the soul.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-1">
            {/* Beige primary (no underline, keep bg; text turns gold) */}
            <Link
              href="/collections"
            ...
            {/* White secondary (keep square white on hover; just text gold) */}
            <a
              href="#intentions"
            ...
            {/* Gold accent (optional third CTA we had) */}
            <Link
              href="/quiz"
      ...
      {/* subtle divider line with lower glow */}
