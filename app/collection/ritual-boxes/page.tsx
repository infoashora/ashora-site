...
const TITLE = "Ritual Boxes";
const SUB = "Compact sets with cards to guide your daily ritual practice.";
...
export default function RitualBoxesCollectionPage() {
  // match your Product.kind union ('ritual-box' in lowercase)
  const items = PRODUCTS.filter((p) => p.kind === "ritual-box");
